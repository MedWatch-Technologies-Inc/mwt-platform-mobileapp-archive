//url:https://github.com/OwnWeb/map_elevation
//commit:ce697a2488b3b34436986c2647c1fa85054a5d3e
...
class _ElevationPainter extends CustomPainter {
  ...
  _ElevationPainter(this.points,
    ...
    _relativeAltitudes = points!
        .map((point) => (point.altitude - _min!) / (_max! - _min!))
        .toList();
  }
