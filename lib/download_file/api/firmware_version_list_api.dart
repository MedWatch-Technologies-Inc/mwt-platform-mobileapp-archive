...
class FirmwareVersionListApi extends ApiCall {
  Future<FirmwareVersionListModel> callApi(String url, var strJson) async {
    try {
      ...
      print(response);
      return FirmwareVersionListModel.fromJson(jsonDecode(response.body));
