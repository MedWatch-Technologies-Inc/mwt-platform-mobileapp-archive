...
class BPWeekItem extends StatelessWidget {
  const BPWeekItem({
    required this.bpDateDisplay,
    required this.onChange,
    super.key,
  });

  final BPDateDisplay bpDateDisplay;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(bpDateDisplay.isShowDetails ? 0.h : 10.h),
                  bottomRight: Radius.circular(bpDateDisplay.isShowDetails ? 0.h : 10.h),
