...
class MHWeekItem extends StatelessWidget {
  const MHWeekItem({
    required this.mhDateDisplay,
    required this.onChange,
    super.key,
  });

  final MHDateDisplay mhDateDisplay;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(mhDateDisplay.isShowDetails ? 0.h : 10.h),
                  bottomRight: Radius.circular(mhDateDisplay.isShowDetails ? 0.h : 10.h),
