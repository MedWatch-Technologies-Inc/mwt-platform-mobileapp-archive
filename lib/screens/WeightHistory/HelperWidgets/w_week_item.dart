...
class WHWeekItem extends StatelessWidget {
  const WHWeekItem({
    required this.whDateDisplay,
    required this.onChange,
    super.key,
  });

  final WHDateDisplay whDateDisplay;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(whDateDisplay.isShowDetails ? 0.h : 10.h),
                  bottomRight: Radius.circular(whDateDisplay.isShowDetails ? 0.h : 10.h),
