...
class WeightToggle extends StatefulWidget {
  ...
  @override
  _WeightToggleState createState() => _WeightToggleState();
}

class _WeightToggleState extends State<WeightToggle> {

  @override
  Widget build(BuildContext context) {
    print('WeightWidget :: ${widget.selectedUnit}');
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  decoration: widget.selectedUnit == 2
                      ? ConcaveDecoration(
                  ...
                  child: Center(
                    ...
                    child: toggleText(widget.unitText1, widget.selectedUnit == 1),
                  ),
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Center(
                    ...
                    child: toggleText(widget.unitText2, widget.selectedUnit == 2),
                  ),
                ),
              ),
            ),
