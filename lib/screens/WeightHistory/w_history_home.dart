...
import 'package:health_gauge/screens/WeightHistory/HelperWidgets/w_day_item.dart';
import 'package:health_gauge/screens/WeightHistory/HelperWidgets/w_history_appbar.dart';
import 'package:health_gauge/screens/WeightHistory/HelperWidgets/w_week_item.dart';
...
class WHistoryHome extends StatefulWidget {
  const WHistoryHome({super.key});

  @override
  State<WHistoryHome> createState() => _WHistoryHomeState();
}

class _WHistoryHomeState extends State<WHistoryHome> with SingleTickerProviderStateMixin {
  final WHistoryHelper _helper = WHistoryHelper();
                ...
                children: [
                  SmartRefresher(
                    ...
                    child: ValueListenableBuilder(
                      ...
                      builder: (BuildContext context, List<WHistoryModel> value, Widget? child) {
                        if (value.isEmpty) {
                          return Center(
                            child: Body1AutoText(
                  ...
                  SmartRefresher(
                    ...
                    child: ValueListenableBuilder(
                      ...
                      builder: (BuildContext context, List<WHDateDisplay> value, Widget? child) {
                        return SingleChildScrollView(
                          padding: EdgeInsets.symmetric(vertical: 5.h, horizontal: 20.w),
                          physics: BouncingScrollPhysics(),
                          child: Column(
                            children: _helper.displayWeekDate.value.map(
                              (e) {
                                ...
                                var whDateDisplay = _helper.displayWeekDate.value.elementAt(index);
                                return Container(
                                  margin: EdgeInsets.symmetric(vertical: 5.h),
                                  child: Column(
                                    children: [
                                      ValueListenableBuilder(
                                        valueListenable: whDateDisplay.showDetails,
                                        builder: (BuildContext context, bool value, Widget? child) {
                                          return WHWeekItem(
                                            whDateDisplay: whDateDisplay,
                                            onChange: () {
                                              if (!whDateDisplay.isShowDetails) {
                                                _helper.selectedWeek.value =
                                                    DateFormat(DateUtil.ddMMMMyyyy)
                                                        .parse(whDateDisplay.title);
                                                _helper.gayData();
                                          ...
                                          return Container(
                                            ...
                                            child: ValueListenableBuilder(
                                              ...
                                              builder: (BuildContext context,
                                                  List<WHistoryModel> value, Widget? child) {
                                                if (value.isEmpty) {
                                                  return SizedBox(
                                                    height: 80.h,
                                                    child: Center(
                          ...
                          child: Column(
                            children: _helper.displayMonthDate.value.map(
                              (e) {
                                ...
                                var whDateDisplay = _helper.displayMonthDate.value.elementAt(index);
                                return Container(
                                  margin: EdgeInsets.symmetric(vertical: 5.h),
                                  child: Column(
                                    children: [
