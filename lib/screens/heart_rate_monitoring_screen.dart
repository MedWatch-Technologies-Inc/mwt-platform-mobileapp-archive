...
class HeartRateMonitoringScreen extends StatefulWidget {
  @override
  _HeartRateMonitoringScreenState createState() => _HeartRateMonitoringScreenState();
}

class _HeartRateMonitoringScreenState extends State<HeartRateMonitoringScreen> {
      ...
      appBar: PreferredSize(
          ...
          child: Container(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: Text(
                StringLocalization.of(context).getText(StringLocalization.hrBPMonitoring),
                style: TextStyle(
  ...
  Widget heartRateMonitorSwitch() {
    return ListTile(
        title: Text(StringLocalization.of(context).getText(StringLocalization.hrBPMonitoring)),
        trailing: Padding(
          padding: EdgeInsets.zero,
          key: Key('clickOnHRMonitoringToggle'),
          child: ValueListenableBuilder(
              valueListenable: _helper.deviceSettingNotifier,
              builder: (context, value, widget) {
                return CustomSwitch(
                  value: value?.hrMonitoring.status ?? true,
                  onChanged: (value) {
  ...
  Widget setTimeInterval() {
    return ValueListenableBuilder(
        ...
        builder: (context, value, widget) {
          return ListTile(
            onTap: () {
              // var selectedIndex = timeIntervalList.indexOf(value?.hrMonitoring.timeInterval.toInt() ?? 5);
              // if (selectedIndex > -1) {
              //   timeIntervalController = FixedExtentScrollController(
            ...
            trailing: Row(
              ...
              children: <Widget>[
                Text('${value?.hrMonitoring.timeInterval.toInt()} min'),
          ...
          Container(
            ...
            children: [
              ...
              FlatBtn(
                  onPressed: () {
                    try {
                      _helper.deviceSetting?.hrMonitoring.timeInterval =
