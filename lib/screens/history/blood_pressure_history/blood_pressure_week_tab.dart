...
class BloodPressureWeekTab extends StatefulWidget {
  const BloodPressureWeekTab({Key? key}) : super(key: key);

  @override
  _BloodPressureWeekTabState createState() => _BloodPressureWeekTabState();
}

class _BloodPressureWeekTabState extends State<BloodPressureWeekTab>
  ...
  Widget build(BuildContext context) {
    ...
    // );
    return Consumer<BloodPressureWeekDataProvider>(
      builder: (BuildContext context, BloodPressureWeekDataProvider provider,
          Widget? child) {
                  ...
                  data: HistoryTileModel(
                    ...
                    graphWidget: !(provider.isLoading) &&
                        ...
                        ? HistoryGraphModel(
                            ...
                            lineChartSeries: provider.getBPLineSeries(
                                provider.startDate.add(Duration(days: index)),
                                provider.startDate
                                    .add(Duration(days: index + 1))),
                            showXGridLines: true,
  ...
  List<List<BPModel>> distinctList(var dataList) {
    ...
    try {
      ...
      LoggingService()
          .printLog(tag: 'BP history screen', message: e.toString());
    }
    return list;
  }
