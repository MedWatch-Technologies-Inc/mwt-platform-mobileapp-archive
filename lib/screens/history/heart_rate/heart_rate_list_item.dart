...
class HeartRateListItem extends StatefulWidget {
  final HrDataModel? model;

  final GestureTapCallback? onClickItem;

  const HeartRateListItem({Key? key, this.model, this.onClickItem})
      : super(key: key);

  @override
  _HeartRateListItemState createState() => _HeartRateListItemState(model!);
}

class _HeartRateListItemState extends State<HeartRateListItem> {
  final HrDataModel model;

  _HeartRateListItemState(this.model);
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Body1Text(
                      text: removeTrailingZero('${model.hr ?? ''}'),
                      fontSize: 16.sp,
                      color: Theme.of(context).brightness == Brightness.dark
