...
class HeartRateWeekTab extends StatefulWidget {
  const HeartRateWeekTab({Key? key}) : super(key: key);

  @override
  _HeartRateWeekTabState createState() => _HeartRateWeekTabState();
}

class _HeartRateWeekTabState extends State<HeartRateWeekTab>
  ...
  Widget build(BuildContext context) {
    return Consumer<HeartRateWeekDataProvider>(
      builder: (BuildContext context, HeartRateWeekDataProvider provider,
          Widget? child) {
                  ...
                  data: HistoryTileModel(
                    ...
                    graphWidget: !(provider.isLoading) &&
                        ...
                        ? HistoryGraphModel(
                            ...
                            lineChartSeries: provider.getHrLineSeries(
                                provider.startDate.add(Duration(days: index)),
                                provider.startDate
                                    .add(Duration(days: index + 1))),
                            showXGridLines: true,
