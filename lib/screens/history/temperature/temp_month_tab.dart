...
import 'temp_list_item.dart';

class TempMonthTab extends StatefulWidget {
  const TempMonthTab({Key? key}) : super(key: key);

  @override
  _TempMonthTabState createState() => _TempMonthTabState();
}

class _TempMonthTabState extends State<TempMonthTab> with AutomaticKeepAliveClientMixin{
  ScrollController scrollController = ScrollController();

  @override
  void initState() {
    Future.delayed(Duration.zero).then((value) {
      var provider = Provider.of<TempMonthDataProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    // );
    return Consumer<TempMonthDataProvider>(
      builder: (BuildContext context, TempMonthDataProvider provider,
          Widget? child) {
  ...
  List<List<TempModel>> distinctList(List<TempModel> dataList) {
    try {
    ...
    try {
      ...
      LoggingService().printLog(
          ...
          message: 'combining all data for a single day in month tab view.');
    }
