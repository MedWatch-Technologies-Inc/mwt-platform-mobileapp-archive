...
import 'package:health_gauge/utils/slider/src/widgets/slidable_dismissal.dart';
...
class SlidableData extends InheritedWidget {
  ...
  /// The number of actions.
  int get actionCount => actionDelegate.actionCount;
...
class SlidableState extends State<Slidable>
  ...
  late AnimationController _overallMoveController;
  ...
  late Size _sizePriorToCollapse;
  ...
  void _handleDragEnd(DragEndDetails details) {
    ...
    final bool fast = velocity.abs() > widget.fastThreshold!.toDouble();
