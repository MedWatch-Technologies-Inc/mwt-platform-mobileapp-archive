...
const double _kTimePickerHeaderControlHeight = 55.0;

const double _kTimePickerWidthPortrait = 309.0;
const double _kTimePickerWidthLandscape = 528.0;

const double _kTimePickerHeightInput = 226.0;
const double _kTimePickerHeightPortrait = 463.0;
...
const BorderRadius _kDefaultBorderRadius = BorderRadius.all(Radius.circular(10.0));
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            width: 119,
            child: Body1Text(
               text: stringLocalization.getText(StringLocalization.selectTime).toUpperCase(),
                    fontSize: 12,
    ...
    return Container(
      ...
      child: Material(
        ...
        color: Theme.of(context).brightness == Brightness.light ?
                                  isSelected ? Color(0xffFFDFDE).withOpacity(0.75) : Color(0xffEEF1F1) :
                                  isSelected ? Color(0xffCC0A00).withOpacity(0.2) : Color(0xff111B1A),
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                    ...
                    color: Theme.of(context).brightness == Brightness.dark ? Color(0xffffffff).withOpacity(0.87) : Color(0xff384341)
                ),
                textScaleFactor: 1.0,
              ),
            ),
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(
              fontWeight: FontWeight.bold,
              fontSize: 30,
              color: Theme.of(context).brightness == Brightness.dark ? Colors.white.withOpacity(0.87) : HexColor.fromHex("#384341"),
            ),
            textScaleFactor: 1.0,
...
class _DayPeriodControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget amButton = Material(
      ...
      color: Theme.of(context).brightness == Brightness.dark ? Color(0xff111B1A): Color(0xffEEF1F1),
      child: InkWell(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 14,
                  color: amSelected ? Color(0xffFF6259) : Color(0xff7F8D8C)
              ),
              textScaleFactor: 1,
            ),
          ),
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 14,
                color: pmSelected ? Color(0xffFF6259) : Color(0xff7F8D8C)
              ),
              textScaleFactor: 1,
            ),
          ),
...
class _RenderInputPadding extends RenderShiftedBox {
  ...
  bool hitTest(BoxHitTestResult result, { required Offset position }) {
    ...
    if (position.dx < 0.0 ||
        position.dx > math.max(child?.size.width ?? 0, minSize.width) ||
        position.dy < 0.0 ||
        position.dy > math.max(child?.size.height ?? 0, minSize.height)) {
      return false;
    }

    Offset newPosition = child?.size.center(Offset.zero) ?? Offset.zero;
    switch (orientation) {
      case Orientation.portrait:
...
//    final ByteData data = await rootBundle.load("asset/clockHand.png");
...
//   canvas.drawArc(rect, startAngle, sweepAngle, useCenter, selectorPaint);

//    final path = Path()
//      ..moveTo(centerPoint.dx + 10, centerPoint.dy + 10)
//      ..lineTo(focusedPoint.dx, focusedPoint.dy)
//      ..quadraticBezierTo(centerPoint.dx + 20, 50,centerPoint.dy + 20, 130);
//    final paint = Paint()
//      ..color = Colors.black
...
//      ..arcToPoint(Offset(centerPoint.dx+10, centerPoint.dy+10),
//      radius: Radius.circular(100),
//        clockwise: false
//      );
//    canvas.drawPath(path, selectorPaint);

//    canvas.drawImage(image, centerPoint, selectorPaint);
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Theme.of(context).brightness == Brightness.dark ? AppColor.darkBackgroundColor : AppColor.backgroundColor,
          image: DecorationImage(
            image: Theme.of(context).brightness == Brightness.dark ? AssetImage('asset/ellipse_dark.png'): AssetImage('asset/ellipse_light.png'),
          )
        ),
        child: CustomPaint(
...
class _TimePickerInputState extends State<_TimePickerInput> {
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData theme = Theme.of(context);
    final TextStyle hourMinuteStyle = TimePickerTheme.of(context).hourMinuteTextStyle ?? theme.textTheme.headlineMedium!;
    bool onTapHour = false;
    bool onTapMin = false;
    return Padding(
...
class _TimePickerDialogState extends State<_TimePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = Row(
      children: <Widget>[
        ...
        IconButton(
          ...
          icon: _entryMode == TimePickerEntryMode.dial ? Image.asset('asset/keyboard_icon.png') : Image.asset('asset/clock_icon.png'),

          // Icon(_entryMode == TimePickerEntryMode.dial ? Icons.keyboard : Icons.access_time),
            ...
            child: OverflowBar(
              ...
              children: <Widget>[
                TextButton(
                  ...
                  child: Text(widget.cancelText ?? MaterialLocalizations.of(context).cancelButtonLabel,
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                ...
                TextButton(
                  onPressed: _handleOk,
                  child: Text(widget.confirmText ?? MaterialLocalizations.of(context).okButtonLabel,style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Color(0xff00AFAA),
                  ),),
    ...
    return Dialog(
      ...
      backgroundColor: Theme.of(context).brightness == Brightness.dark ? Color(0xff111B1A) : Color(0xffEEF1F1),
