...
class CirclePainter extends CustomPainter {
  ...
  CirclePainter(
    ...
    _paintBackground.strokeWidth = backgroundWidth ?? 1.0;
    ...
    if (arcBackgroundColor != null) {
      ...
      _paintBackgroundStartAngle.strokeWidth = lineWidth ?? 1.0;
    ...
    _paintLine.color = progressColor ?? Colors.transparent;
    _paintLine.style = PaintingStyle.stroke;
    _paintLine.strokeWidth = lineWidth ?? 1.0;
    if (circularStrokeCap == CircularStrokeCap.round) {
